...
- The current Release executable SHA-256 is `89458C3E6AAB2317964822C00C4CDA324D2A050F3AF7C3639A18D50237CE1312`. It is x64, GUI-subsystem, unsigned, uses the static MSVC runtime, and imports only Windows system DLL/API sets.
...
- Run the Release single-instance/portable-scene GUI smoke and idle-resource checks after that exact GUI output is authorized. Both current clean CTests and equivalent current-source Debug runtime coverage pass.
